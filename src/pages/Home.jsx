  ...
  return (
    <div className="space-y-6 pb-4">
              ...
              return (
                <Link key={r.region} to={"/schools?region="+r.region} className="flex items-center gap-2 group">
                  ...
                  <div className="flex-1 bg-gray-100 rounded-full h-5 overflow-hidden">
                    <div className="h-full bg-navy rounded-full transition-all group-hover:bg-navy-light flex items-center pl-2" style={{width: pct+"%"}}>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Link to="/qa" className="card p-4 flex items-center gap-3 hover:shadow-md transition">
          <span className="text-2xl">💬</span>
          <div>
            <div className="font-extrabold text-sm text-navy">커뮤니티</div>
            <div className="text-xs text-gray-400">질문 · 정보 공유</div>
          </div>
        </Link>
      </div>
